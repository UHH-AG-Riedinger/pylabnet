...
from pylabnet.hardware.arduino_Laser_Sign.arduino_Laser_Sign import Driver
from pylabnet.network.core.generic_server import GenericServer
from pylabnet.network.client_server.arduino_Laser_Sign import Service, Client
...
def launch(**kwargs):
    ...
    try:
        settings = load_device_config('arduino_Laser_Sign',
                                      kwargs['config'],
    ...
    try:
        ...
        pm = Driver(port='COM8', baudrate=9600, logger=kwargs['logger'])
