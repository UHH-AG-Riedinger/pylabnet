...
from pylabnet.hardware.zwoastro.ZWOCamera import Driver
from pylabnet.network.core.generic_server import GenericServer
from pylabnet.network.client_server.ZWOCamera import Service, Client
...
def launch(**kwargs):
    ...
    try:
        settings = load_device_config('ZWOCamera',
                                      kwargs['config'],
    ...
    # the correct resource string
        ...
        kwargs['logger'].error('An error occured while creating Object of Camera')
