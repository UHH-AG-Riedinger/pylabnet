...
class Service(ServiceBase):
    ...
    def exposed_send_area_scan_0to1024(self, x_steps, y_steps, x_center=-1, y_center=-1, times=100):
        return self._module.send_area_scan_0to1024(x_steps, y_steps, x_center=-1, y_center=-1, times=100)
...
class Client(ClientBase):
    ...
    def send_area_scan_0to1024(self, x_steps, y_steps, x_center=-1, y_center=-1, times=100):
        return self._service.exposed_send_area_scan_0to1024(x_steps, y_steps, x_center=-1, y_center=-1, times=100)
