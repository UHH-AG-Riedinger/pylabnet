...
#print(pmX.applyVoltageToDAC0to1024("DAC0", 730))#394 y axis#80#814

pmX.send_area_scan_0to1024(500, 700, 730, 512, times=0)

#pmX.send_area_scan_0to1024(160, 550, 80, 375, times=0)
#pmX.send_area_scan_0to1024(420, 550, 813, 725, times=0)
